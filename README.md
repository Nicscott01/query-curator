...
- Saving via **Save Posts** or the main WordPress **Update** button keeps the curated list in sync, clears the query group cache, and triggers SpinupWP cache purging when available
...
5. Click **Save Posts** to persist the curated order, or use the main WordPress **Update** button to save the post and curated list together. On SpinupWP sites, either action also purges the relevant caches.
